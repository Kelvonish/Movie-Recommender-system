...
function getReviews() {
    let movieId = sessionStorage.getItem('id');
    axios.get(`https://api.themoviedb.org/3/movie/${movieId}/similar?api_key=5ec279387e9aa9488ef4d00b22acc451&language=en-US&page=1`)
            ...
            $.each(movies, (index, movie) => {
              ...
              /*  output += `
                        <div class="row review">
                            ...
                            <div class="col-md-10 box-review2">
                                <h5>Reviewed by ${movie.title}</h5>
                                <div class="content">
                                    <p style="color:silver;">${movie.release_date}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 box2">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active">
                            <strong>Budget: </strong> $ ${budget} </li>
                        <li class="list-group-item active">
                            <strong>Revenue: </strong> $ ${revenue} </li>
                    </ul>

                </div>

                <div class="col-md-4 box3">
                    <h1 class="title-second">Plot</h1>
                    <p>${movie.overview}</p>
...
console.log('[genre]', genre);
    axios.get('https://api.themoviedb.org/3/discover/movie?api_key=5ec279387e9aa9488ef4d00b22acc451&with_genres='+genreId+'&language=en-US&page=1')
        .then((response) => {
            console.log(response);
